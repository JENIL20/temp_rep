    ...
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-8">
      ...
      <div className="mb-8 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <PermissionGate module="CATEGORY_MANAGEMENT" permission="category_add">
            <button
              ...
              >
                <div className="grid grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-2 flex items-center justify-end gap-2 opacity-50 group-hover:opacity-100 transition-opacity">
                    <PermissionGate module="CATEGORY_MANAGEMENT" permission="category_edit">
                      <button
                    ...
                    <PermissionGate module="CATEGORY_MANAGEMENT" permission="category_delete">
                      <button
