...
const Profile = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        bio: user?.bio || "Passionate learner and educator focused on web development and modern technologies.",
            ...
            reader.onloadend = () => {
                ...
                if (user) {
                    dispatch(setCredentials({
                        user: { ...user, avatarUrl: base64String },
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-base text-gray-900">{user?.phone || formData.phone}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-base text-gray-900">{user?.location || formData.location}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <a href={user?.website || formData.website} className="text-base text-blue-600 hover:underline">
                                            ...
                                            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <a href={user?.linkedin || formData.linkedin} className="text-base text-blue-600 hover:underline">
                                            ...
                                            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-base text-gray-900">{user?.twitter || formData.twitter}</p>
                                                </div>
                                            </div>
                                        </div>
