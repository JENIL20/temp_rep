...
export const DUMMY_VIDEOS: CourseVideoResponse[] = [
  {
    ...
    description:
      'Getting started with the environment setup and "Hello World".',
    videoUrl:
      "https://drive.google.com/file/d/1TXdWRMHjjtFKeXsj9sPIustkftCrjfQN/view?usp=drive_link",
    duration: 1200,
    orderIndex: 1,
  ...
  },
  {
    ...
    description:
      "Understanding functional components, props, and basic styling.",
    videoUrl:
      "http://keratometric-autotypic-collin.ngrok-free.dev/api/CourseVideo/stream/1015",
    duration: 1500,
    orderIndex: 2,
    ...
    try {
      ...
      if (data.file) {
        ...
        const response = await api.post(
          API.COURSE_VIDEO.CREATE(data.courseId),
          formData,
          {
            headers: {
